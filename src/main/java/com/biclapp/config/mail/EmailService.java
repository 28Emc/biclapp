    ...
    private String armarPlantilla(Map<String, Object> model, String tipoOperacion) {
        ...
        switch (tipoOperacion) {
            ...
            case "REGISTRO PEDIDO":
                ...
                body = "<body> <div class='container'> <table aria-hidden='true'> <tr> <td id class='imagen'> <img src='https://storage.googleapis.com/bucket-citybike-lima-delivery/app-images/logo-citybikelima-delivery.png' alt='confirma-pedido' width='50%' /> </td> </tr> <tr> <td> <hr> </td> </tr> <tr> <td id class='content'> <h3 class='titulo'>" + model.get("titulo-cabecera").toString() + "</h3> <h3 class='texto'>Saludos, le informamos que hemos registrado su pedido de los siguientes artículos: </h3> <tr> <td> <table style='text-align: center'> <tr> <td colspan='2'>PEDIDO</td> </tr><tr></tr><tr></tr><tr></tr> <tr> <td colspan='1'>CÓDIGO</td> <td colspan='1'>" + idPedido + "</td> </tr> <tr> <td colspan='1'>TIPO PEDIDO</td> <td colspan='1'>" + formatTipoPedido(pedidoDet.getTipo_pedido()) + "</td> </tr> <tr> <td colspan='1'>DIRECCIÓN</td> <td colspan='1'>" + pedidoDet.getDireccion() + "</td>    <tr> <td colspan='1'>FECHA DE PEDIDO</td> <td colspan='1'>" + pedidoDet.getFecha_registro() + "</td> </tr>    </tr> <tr></tr> <tr></tr><tr></tr><tr></tr><tr></tr><tr><td colspan='2'>DETALLES PEDIDO</td></tr>";
            ...
            case "PEDIDO EN CURSO":
                Pedidos pedidoFound = (Pedidos) model.get("pedido");
                String tipoPedido = formatTipoPedido(pedidoFound.getTipo_pedido());
                idPedido = pedidoFound.getId();
                body = "<body> <div class='container'> <table aria-hidden='true'> <tr> <td id class='imagen'> <img src='https://storage.googleapis.com/bucket-citybike-lima-delivery/app-images/logo-citybikelima-delivery.png' alt='confirma-pedido' width='50%' /> </td> </tr> <tr> <td> <hr> </td> </tr> <tr> <td id class='content'> <h3 class='titulo'>" + model.get("titulo-cabecera").toString() + "</h3> <h3 class='texto'>Saludos, le informamos que su pedido ha sido confirmado. </h3> <tr> <td> <table style='text-align: center'> <tr> <td colspan='2'>PEDIDO</td> </tr><tr></tr><tr></tr><tr></tr> <tr> <td colspan='1'>CÓDIGO</td> <td colspan='1'>" + idPedido + "</td> </tr> <tr> <td colspan='1'>TIPO PEDIDO</td> <td colspan='1'>" + tipoPedido + "</td> </tr> <tr> <td colspan='1'>DIRECCIÓN</td> <td colspan='1'>" + pedidoFound.getDireccion() + "</td></tr>       <tr> <td colspan='1'>FECHA DE PEDIDO</td> <td colspan='1'>" + pedidoFound.getFecha_registro() + "</td> </tr> <tr> <td colspan='1'>FECHA DE ENTREGA</td> <td colspan='1'>" + pedidoFound.getFecha_entrega().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")) + "</td> </tr>   </td> </tr> <tr> <td colspan='1'>HORA ESTIMADA</td> <td colspan='1'>Se realizará la coordinación según la disponibilidad del cliente.</td> </tr>     <tr></tr> <tr></tr><tr></tr><tr></tr><tr></tr><tr><td colspan='2'>DETALLES PEDIDO</td></tr>";
                List<DTODetallePedido> pedidosWithDetails = (List<DTODetallePedido>) model.get("detalle-pedido");
                pedidosWithDetails.forEach(item -> {
                    double costo;
                    String producto = "";
                    ...
                    detail.append("<tr> <td colspan='1'>PRODUCTO</td> <td colspan='1'>").append(producto).append("</td> </tr> <tr> <td colspan='1'>CANTIDAD</td> <td colspan='1'>").append(item.getCantidad()).append("</td> </tr> <tr> <td colspan='1'>PRECIO</td> <td colspan='1'>").append((!pedidoFound.getTipo_pedido().equals("C")) ? "S/. " : "").append(costo).append("</td> </tr> <tr></tr><tr></tr><tr></tr><tr></tr>");
                });
                //detail.append("<tr> <td colspan='1'>FECHA DE ENTREGA</td> <td colspan='1'>").append(pedidoFound.getFecha_entrega().format(DateTimeFormatter.ofPattern("dd-MM-yyyy"))).append("</td> </tr> <tr> <td colspan='1'>HORA ESTIMADA</td> <td colspan='1'>Se realizará la coordinación según la disponibilidad del cliente</td> </tr>");
                detail.append("</table></td></tr>");
                body = body.concat("<td> <hr> </td>");
                break;
